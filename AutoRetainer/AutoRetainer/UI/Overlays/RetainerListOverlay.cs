...
internal unsafe class RetainerListOverlay : Window
{
    ...
    public RetainerListOverlay() : base("AutoRetainer 僱員列表覆蓋層", ImGuiWindowFlags.NoDecoration | ImGuiWindowFlags.AlwaysAutoResize | ImGuiWindowFlags.NoFocusOnAppearing, true)
    {
