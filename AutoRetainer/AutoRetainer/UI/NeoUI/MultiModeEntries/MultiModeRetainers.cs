...
public class MultiModeRetainers : NeoUIEntry
{
    ...
    public override NuiBuilder Builder { get; init; } = new NuiBuilder()
        ...
        .DragInt(60f, "提前重登閾值(秒)", () => ref C.MultiModeRetainerConfiguration.AdvanceTimer.ValidateRange(0, 300), 0.1f, 0, 300)
        .SliderInt(100f, "繼續操作所需的最小背包空格", () => ref C.MultiMinInventorySlots.ValidateRange(2, 9999), 2, 30)
