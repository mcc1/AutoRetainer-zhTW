...
- [Program.cs](/workspaces/AutoRetainerLocalizer/Program.cs)
- [TranslationRewriter.cs](/workspaces/AutoRetainerLocalizer/TranslationRewriter.cs)
...
[TranslationRewriter.cs](/workspaces/AutoRetainerLocalizer/TranslationRewriter.cs) 目前已修正一般插值字串 escaping，會正確轉義：
